...
export default function ModalBox({handleClose}:props) {
    return (
        <>
            <div
            className="container xl:px-6 px-2 justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none"
            >
